...
const inventory = [
  ...
  { name: "gerd", quantity: ["acid reflux", "chest pain", "difficulty swallowing/chewing"] , Image:"Images/gerd.jpg", Link:"Links/Mayo Clinic - Mayo Clinic.html", href:"Links/Mayo Clinic - Mayo Clinic.html",discription:"Gastroesophageal reflux disease occurs when stomach acid repeatedly flows back to the esophagus and stomach. This backwash (acid reflux) can irritate the lining of your esophagus. When the acid reflux happens repeatedly over time, it can cause GERD."},
  ...
  { name: "epilepsy", quantity: ["seizure"] , Image:"Images/epilepsy.jpg", Link:"Links/Epilepsy - Symptoms and causes - Mayo Clinic.html", href:"Links/Epilepsy - Symptoms and causes - Mayo Clinic.html",discription:"A neurological disorder in which brain activity becomes abnormal. This causes seizures or loss of awareness."},
  ...
  { name: "alzheimer's", quantity: ["memory loss"] , Image:"Images/alzheimers.jpg", Link:"Links/Alzheimer's disease - Symptoms and causes - Mayo Clinic.html", href:"Links/Alzheimer's disease - Symptoms and causes - Mayo Clinic.html",discription:"Alzeimers is a neurological disorder that causes the brain to shrink and is the most common cause of dementia. 50 million people worldwide suffer from dementia."},
  ...
  { name: "parkinson's", quantity: ["depression", "diffculty swallowing/chewing"] , Image:"Images/parkinsons.jpg", Link:"Links/Parkinson's disease - Symptoms and causes - Mayo Clinic.html", href:"Links/Parkinson's disease - Symptoms and causes - Mayo Clinic.html",discription:"Parkinson's Disease is a brain disorder which leads to shaking or tremors. This can lead to trouble with coordination and daily activities, such as walking, eating etc. Parkinsons is caused by destroyed noradrenaline-producing neurons, which are responsible for sending signals to muscles. Parkinson's disease affects around 1 million Americans and is the second most common neurodegenerative disorder after Alzheimer’s disease."},
